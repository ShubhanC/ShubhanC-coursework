...
public:
   ...
   */
  int GetDeltaRow(int row, int col) const;
  int GetDeltaCol(int row, int col) const;
...
private:
   ...
   * Add any helper methods you may need
   */
  int FindHorizontalSeam(int**& values) const;
  int FindVerticalSeam(int**& values) const;
  int FindStartingCol(int** values, int best_value) const;
  int FindStartingRow(int** values, int best_value) const;
};
